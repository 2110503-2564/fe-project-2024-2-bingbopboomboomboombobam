...
export default function Home() {
  return (
    <div className="bg-s-grey-1100 min-h-screen">
      <div className="relative pb-10 flex flex-col items-center">
        ...
        <div className="w-[880px] gap-2 flex flex-row justify-center items-center pb-5 pt-5">
          ...
          <div className="relative grow h-86 flex flex-col justify-center items-start">
        ...
        <div className="w-[880px] flex flex-col items-left pt-5 pb-2 text-white">
          <div className="text-3xl font-semibold">
            Customer Reviews
          </div>
          <div className=" text-base font-normal w-2/3">
        ...
        <div className="w-[880px] flex flex-row justify-center gap-2 pb-5 pt-2">
